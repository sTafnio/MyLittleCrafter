...
public static class HarvestBenchHandler
{
    ...
    public static InventSlotItem InventSlotItemInHarvestBench => InventoryHandler.GetCraftableInventSlotItemsFromServerInventory(HarvestBenchServerInventory).FirstOrDefault();
    ...
    public static RectangleF HarvestCraftButtonRect => HarvestWindow.GetChildFromIndices(11, 1).GetClientRect();
    public static string HarvestSearchFieldText => HarvestWindow?.GetChildFromIndices(8, 1, 0)?.Text?.Trim() ?? string.Empty;
    public static RectangleF ItemInHarvestBenchRect => HarvestWindow.GetChildFromIndices(11, 0, 0, 0).GetClientRect();
